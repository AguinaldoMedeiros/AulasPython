...
import copy
from intermediário.dados import produtos_m
...
novos_produtos = [{**produto,'preco': produto['preco']*1.10} for produto in novos_produtos]
...
produtos_ordenados_por_preco = sorted(produtos_ordenados_por_preco, key=lambda item:
                                      item['preco'], reverse=True)
